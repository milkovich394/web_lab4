const exceedData= {
    title: "Запроси ранний доступ",
    img: {
      src: "./assets/img/exceeding_all_expectations.png",
      alt: "not-found",
    },
  
    header: "Превосходя все ожидания",
    content: `Однако кровать для помощи в путешествии неприятна.
